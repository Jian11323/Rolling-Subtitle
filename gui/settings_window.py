...
class SettingsWindow(QDialog):
    ...
    def _create_data_source_tab(self):
        ...
        gw_layout.addWidget(self.fanstudio_parse_cea_cb)
        self.fanstudio_parse_cea_pr_cb = _fs_cb('fanstudio_parse_cea_pr', "中国地震预警省网")
        gw_layout.addWidget(self.fanstudio_parse_cea_pr_cb)
        self.fanstudio_parse_cwa_eew_cb = _fs_cb('fanstudio_parse_cwa_eew', "台湾气象署地震预警")
        gw_layout.addWidget(self.fanstudio_parse_cwa_eew_cb)
        self.fanstudio_parse_jma_cb = _fs_cb('fanstudio_parse_jma', "日本气象厅地震预警")
        gw_layout.addWidget(self.fanstudio_parse_jma_cb)
        self.fanstudio_parse_sa_cb = _fs_cb('fanstudio_parse_sa', "美国ShakeAlert地震预警")
        gw_layout.addWidget(self.fanstudio_parse_sa_cb)
        self.fanstudio_parse_kma_eew_cb = _fs_cb('fanstudio_parse_kma_eew', "韩国气象厅地震预警")
        gw_layout.addWidget(self.fanstudio_parse_kma_eew_cb)
        # 速报 / 气象 / 海啸子源
        self.fanstudio_parse_cenc_cb = _fs_cb('fanstudio_parse_cenc', "中国地震台网中心")
        gw_layout.addWidget(self.fanstudio_parse_cenc_cb)
        self.fanstudio_parse_ningxia_cb = _fs_cb('fanstudio_parse_ningxia', "宁夏地震局")
        gw_layout.addWidget(self.fanstudio_parse_ningxia_cb)
        self.fanstudio_parse_guangxi_cb = _fs_cb('fanstudio_parse_guangxi', "广西地震局")
        gw_layout.addWidget(self.fanstudio_parse_guangxi_cb)
        self.fanstudio_parse_shanxi_cb = _fs_cb('fanstudio_parse_shanxi', "山西地震局")
        gw_layout.addWidget(self.fanstudio_parse_shanxi_cb)
        self.fanstudio_parse_beijing_cb = _fs_cb('fanstudio_parse_beijing', "北京地震局")
        gw_layout.addWidget(self.fanstudio_parse_beijing_cb)
        self.fanstudio_parse_yunnan_cb = _fs_cb('fanstudio_parse_yunnan', "云南地震局")
        gw_layout.addWidget(self.fanstudio_parse_yunnan_cb)
        self.fanstudio_parse_cwa_cb = _fs_cb('fanstudio_parse_cwa', "台湾气象署速报")
        gw_layout.addWidget(self.fanstudio_parse_cwa_cb)
        self.fanstudio_parse_hko_cb = _fs_cb('fanstudio_parse_hko', "香港天文台")
        gw_layout.addWidget(self.fanstudio_parse_hko_cb)
        self.fanstudio_parse_usgs_cb = _fs_cb('fanstudio_parse_usgs', "美国地质调查局速报")
        gw_layout.addWidget(self.fanstudio_parse_usgs_cb)
        self.fanstudio_parse_emsc_cb = _fs_cb('fanstudio_parse_emsc', "欧洲地中海地震中心速报")
        gw_layout.addWidget(self.fanstudio_parse_emsc_cb)
        self.fanstudio_parse_bcsf_cb = _fs_cb('fanstudio_parse_bcsf', "法国中央地震研究所速报")
        gw_layout.addWidget(self.fanstudio_parse_bcsf_cb)
        self.fanstudio_parse_gfz_cb = _fs_cb('fanstudio_parse_gfz', "德国地学研究中心速报")
        gw_layout.addWidget(self.fanstudio_parse_gfz_cb)
        self.fanstudio_parse_usp_cb = _fs_cb('fanstudio_parse_usp', "巴西圣保罗大学速报")
        gw_layout.addWidget(self.fanstudio_parse_usp_cb)
        self.fanstudio_parse_kma_cb = _fs_cb('fanstudio_parse_kma', "韩国气象厅速报")
        gw_layout.addWidget(self.fanstudio_parse_kma_cb)
        self.fanstudio_parse_fssn_cb = _fs_cb('fanstudio_parse_fssn', "FSSN")
        gw_layout.addWidget(self.fanstudio_parse_fssn_cb)
        self.fanstudio_parse_fssn_cmt_cb = _fs_cb('fanstudio_parse_fssn_cmt', "FSSN 矩心矩张量解")
        gw_layout.addWidget(self.fanstudio_parse_fssn_cmt_cb)
        self.fanstudio_parse_weatheralarm_cb = _fs_cb('fanstudio_parse_weatheralarm', "气象预警")
        gw_layout.addWidget(self.fanstudio_parse_weatheralarm_cb)
        self.fanstudio_parse_tsunami_cb = _fs_cb('fanstudio_parse_tsunami', "海啸信息")
    ...
    def _create_advanced_tab(self):
        ...
        # ---------- 2. 中国预估烈度与有感预警 ----------
        sec_int_title = QLabel("预估烈度与全屏闪烁")
